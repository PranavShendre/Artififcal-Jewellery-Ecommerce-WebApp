...
const product = {
  ...
  description:
    "Indulge in the timeless allure of our Pearl Chain, a masterpiece that effortlessly combines sophistication with natures purest gem - freshwater pearls. Each pearl, a gift from the depths of the ocean, has been meticulously handpicked and lovingly strung together to create a necklace that is not just jewelry but a work of art.",
  highlights: [
